...
const CharacterListPage = () => {
  ...
  // It allows us to use the Suspense component provided by React where we use this component.
  // It also eliminates the possibility of the returned data being undefined.
